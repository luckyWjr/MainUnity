...
namespace Tool {
    public abstract class BaseAssetBundleItem {
        /// <summary>
        ...
        public virtual void Load(bool isHasDependence = true) {
            AssetBundleItem assetBundleItem = AssetBundleTool.Load(m_fullPath, name, isHasDependence);
        ...
        public virtual void LoadAsync(Action callback = null, bool isHasDependence = true) {
            m_callback = callback;
            UICoroutine.instance.StartCoroutine(AssetBundleTool.LoadAsync(m_fullPath, name, LoadAsyncCallback, isHasDependence));
        }
